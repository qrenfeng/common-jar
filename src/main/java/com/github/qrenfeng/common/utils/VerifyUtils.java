...
public class VerifyUtils {
     ...
     */
    public static final String REGEX_USERNAME = "^\\w+$";
     ...
     * 正则表达式：验证URL
     */
    public static final String REGEX_URL = "^https?:\\/\\/(([a-zA-Z0-9_-])+(\\.)?)*(:\\d+)?(\\/((\\.)?(\\?)?=?&?[a-zA-Z0-9_-](\\?)?)*)*$";
     ...
     * 正则表达式：邮编
     */
    public static final String REGEX_ZIPCODE = "^[1-9]\\d{5}(?!\\d)$";
     ...
     * 正则表达式：日期时间
     */
    public static final String REGEX_DATETIME = "^\\d{4}((0[1-9])|(1[0-2]))((0[1-9])|([1-2][0-9])|(3([0|1])))((0[0-9])|([1-2][0-9]))((0[0-9])|([1-5][0-9]))((0[0-9])|([1-5][0-9]))$";
